...
### Some of screen-shots of my rode-clone website.
...
[Link](https://vb-rode-clone.netlify.app/)
...
- There is a one impressive feature's is `Responsive`.

> You can see the [Orignal-Web-Site](https://rode.com/en).
...
- For this project i took around `7 to 8 hours` to complete it. The major portion of my time spent in Background-image absolute and other image is shown in the perfection of the screen-size.
